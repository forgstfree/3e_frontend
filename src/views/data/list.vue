<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="标题" min-width="2">
        <template slot-scope="scope">
          <template v-if="scope.row.edit">
            <el-input v-model="scope.row.fields.filename" class="edit-input" size="small" />
      ...
      <el-table-column label="操作" width="250" align="center">
        <template slot-scope="scope">
          ...
          <el-button size="mini" @click="handleReader(scope.row)">查看</el-button>
    ...
    <div>
      ...
      <show-excel ref="showexcel" v-loading="loading" :dialog-visible="dialogVisible" @closeDialog="closeDialog" />
    </div>
  </div>
</template>
...
export default {
  name: 'ShowFile',
  components: { UploadFile, ShowExcel },
  data() {
    return {
      list: null,
      listLoading: true,
